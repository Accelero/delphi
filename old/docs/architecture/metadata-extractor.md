...
Status: **implemented.** Companion to [`title-llm.md`](./title-llm.md) —
second consumer of the non-chat "utility LLM" pattern.
...
Empty input text short-circuits to default (no LLM call).
