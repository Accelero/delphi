...
//! an identity. Today the production implementation is
//! [`super::JwtClaimsExtractor`], which validates `Authorization: Bearer`
//! JWTs in-process before the same token is passed to SurrealDB.
